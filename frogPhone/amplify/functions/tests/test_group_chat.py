...
from shared.group_chat import group_history_from_items, group_round_step, group_runtime_context, select_group_reply_targets
...
class GroupChatTests(unittest.TestCase):
    ...
    def test_context_identifies_people_bots_and_current_turn(self) -> None:
        ...
        self.assertEqual([bot["name"] for bot in context["bots"]], ["Chief", "Research Scout"])
    ...
    def test_later_bot_sees_people_and_earlier_bot_replies(self) -> None:
        ...
        self.assertIn("[Chief]: First, choose an owner.", history[0]["content"][0]["text"])
