...
| Pattern | Representative repositories at review time | HeyTim decision |
| --- | --- | --- |
...
| Deep research | [STORM](https://github.com/stanford-oval/storm) (31,276), [GPT Researcher](https://github.com/assafelovic/gpt-researcher) (29,414), [Alibaba DeepResearch](https://github.com/Alibaba-NLP/DeepResearch) (19,932) | High demand that HeyTim already covers with Research & Reports. Improve source quality and evaluation rather than add a duplicate persona. |
| Realtime voice agents | [Pipecat](https://github.com/pipecat-ai/pipecat) (15,441), [LiveKit Agents](https://github.com/livekit/agents) (14,144) | Popular but currently outside HeyTim's bot-tool surface. Do not imply that speech-to-text in the message composer provides a live voice agent or meeting recorder. |
...
| Inbox assistance | [Inbox Zero](https://github.com/elie222/inbox-zero) (12,189) | HeyTim already creates a private Gmail Assistant after OAuth. Improve or skill-enable that bot after Gmail connections have a stable public dependency or connection recipe; do not add a duplicate public template. Sending is currently unavailable and should remain a separately designed, explicitly approved future capability. |
...
External Codex plugins are not automatically HeyTim runtime tools. Do not reference vidIQ, Fathom, Plaud, Asana, ClickUp, Trello, Dropbox, Box, or Canva from a public bot until HeyTim has a reviewed stable connector ID, credential flow, and runtime binding for that service.
