...
description: Use public YouTube evidence to find a differentiated video opportunity and turn it into a title, outline, and thumbnail brief.
---

# YouTube Strategy

Use this skill when someone wants to choose, position, or plan a YouTube video using current public evidence.

First establish the channel or niche, target viewer, desired outcome, format, geography, and timeframe. Ask only for missing details that would materially change the research. Treat the creator's own audience knowledge as an input, not something public search can replace.
...
Turn the evidence into a compact strategy:

- the target viewer and problem;
- the clearest differentiated promise;
- what the current results cover well and what they leave open;
- three to five viable concepts, each tied to observed evidence;
- title options that are accurate, specific, and meaningfully different;
- a practical outline with the proof, examples, or demonstration each section needs; and
- one thumbnail brief that complements the title instead of repeating it.

Recommend one concept and explain the tradeoff. Keep exploratory ideas separate from factual claims, and identify what the creator should validate with their own analytics before committing.
