...
This directory is the maintained monorepo source for FroggyBot's ready-made bots,
reusable skills and reviewed tool definitions. Imported from the former public
`tmoreton/frog-bots` repository at commit `62a1f53`; its history remains there.

- [froggybot.com](https://froggybot.com) is built from `../apps/website` using Vite and React.
