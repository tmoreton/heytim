  ...
  struct DesktopControlSettingsSection: View {
    ...
    var body: some View {
      Section {
        ...
        Text("Turn this on, then enable Mac app actions for individual bots in their Tools list. Each bot’s Action approvals setting controls whether it asks first. Consequential controls stay blocked.")
      }
