...
# Bundle the pinned, verified Core ML model only in the Mac product. This runs on
# the build machine; the installed app never fetches model weights on demand.
