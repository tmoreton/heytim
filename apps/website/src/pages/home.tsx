...
export function Home() {
  return (<main id="main">
    <section className="hero">
      <div className="hero-copy">
        ...
        <div className="hero-actions">
          <a className="button" href="mailto:support@heytim.ai?subject=HeyTim%20beta%20access">Request beta access <span aria-hidden="true">→</span></a>
      ...
      <div className="product-window" aria-label="Example of a HeyTim group conversation">
        <div className="window-bar"><span className="window-dots"><i></i><i></i><i></i></span><strong>HeyTim</strong><span className="window-status">GROUP MEMORY ON</span></div>
        <div className="conversation">
          <div className="group-name"><img src="/assets/tim-mark.svg" alt="" /><span><strong>Weekend in Portland</strong><small>2 people · 3 specialists</small></span></div>
    ...
    <section className="proof-strip" id="why" aria-label="What makes HeyTim different">
    ...
    <section className="section">
      <div className="section-heading">
        ...
        <h2>Everyone contributes. HeyTim keeps it moving.</h2>
      ...
      <div className="steps">
        ...
        <article className="step"><span className="step-number">2</span><h3>Decide together</h3><p>HeyTim bots compare preferences and options without taking over the conversation.</p></article>
