export function Sms() {
  return (<main className="doc-page" id="main">
    ...
    <p>HeyTim is an independent software product operated by Timothy Moreton. It helps individuals and groups organize conversations, decisions, and useful files. SMS is used only for optional, user-requested passwordless sign-in and account verification. HeyTim does not send promotional or marketing text messages.</p>

    <div className="program-meta"><strong>Program:</strong> HeyTim one-time passcodes<br /><strong>Message frequency:</strong> One message per login attempt; frequency varies<br /><strong>Customer care:</strong> Reply HELP for help or visit https://heytim.ai/sms/<br /><strong>Opt out:</strong> Reply STOP</div>

    <h2>How users opt in</h2>
    <ol>
      <li>The user chooses phone-number sign-in or account creation in HeyTim.</li>
      ...
      <li>HeyTim sends one verification code for that login attempt.</li>
    </ol>
