...
export const styles = StyleSheet.create({
  ...
  mobileBackdrop: { paddingHorizontal: 0 },
  mobileModal: { borderRadius: 0, maxHeight: '100%' },
  ...
  options: { maxHeight: 240, flexGrow: 0 },
  notice: { paddingHorizontal: 12, paddingVertical: 6 },
  ...
  resumeBar: { flexDirection: 'row', alignItems: 'center' },
  remember: { flexDirection: 'row', alignItems: 'center', gap: 10 },
  actions: { flexDirection: 'row', gap: 6, flexWrap: 'wrap', justifyContent: 'flex-end' },
  button: { minHeight: 44, paddingHorizontal: 11, paddingVertical: 8, borderRadius: 9, backgroundColor: '#E5EEE7', alignItems: 'center', justifyContent: 'center' },
