...
export const styles = StyleSheet.create({
  ...
  skillDescription: { color: '#6E6A62', fontSize: 12, lineHeight: 17, marginTop: 4 },
  cardMeta: { color: '#6E6A62', fontSize: 10.5, lineHeight: 15, marginTop: 5 },
  ...
  chevron: { color: '#6E6A62', fontSize: 27, fontWeight: '300' },
  ...
  version: { color: '#6E6A62', fontSize: 11 },
  detailNote: { color: '#6E6A62', fontSize: 12, lineHeight: 17, textAlign: 'center', marginTop: 9 },
  ...
  noTools: { color: '#6E6A62', fontSize: 13, lineHeight: 19 },
  ...
  fieldHelp: { color: '#6E6A62', fontSize: 12, lineHeight: 17, marginTop: -4, marginBottom: 9 },
