...
export function InviteScreen({ invitation, hydrated }: Props) {
  ...
  const deepLink = invitation ? invitationUrl(invitation) : 'frogbot://';
...
const styles = StyleSheet.create({
  ...
  brandName: { color: colors.text, fontSize: 20, fontWeight: '800', letterSpacing: -0.5 },
  card: { maxWidth: 720, borderRadius: 30, overflow: 'hidden', backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border, ...Platform.select({ web: { boxShadow: '0 24px 70px rgba(31,45,35,0.11)' }, default: { shadowColor: '#1F2D23', shadowOpacity: 0.11, shadowRadius: 32, shadowOffset: { width: 0, height: 18 } } }) },
  inviteVisual: { minHeight: 250, backgroundColor: colors.brand, alignItems: 'center', justifyContent: 'center', overflow: 'hidden' },
  glowOne: { position: 'absolute', width: 270, height: 270, borderRadius: 135, backgroundColor: '#1C9358', top: -130, right: -40 },
  glowTwo: { position: 'absolute', width: 220, height: 220, borderRadius: 110, backgroundColor: colors.brandDark, bottom: -130, left: -30 },
  frogCircle: { width: 126, height: 126, borderRadius: 42, backgroundColor: colors.background, alignItems: 'center', justifyContent: 'center', borderWidth: 7, borderColor: 'rgba(255,255,255,0.25)' },
  heroFrog: { width: 98, height: 98, borderRadius: 28 },
  botStack: { position: 'absolute', bottom: 18, flexDirection: 'row', alignItems: 'center' },
  botStackItem: { borderRadius: 23, borderWidth: 3, borderColor: colors.brand, backgroundColor: colors.surface },
  copy: { paddingHorizontal: 26, paddingTop: 30, paddingBottom: 26, alignItems: 'center' },
  eyebrow: { color: colors.brand, fontSize: 11, fontWeight: '800', letterSpacing: 1.5, marginBottom: 10 },
  title: { color: colors.text, fontSize: 32, lineHeight: 37, fontWeight: '800', letterSpacing: -1.1, textAlign: 'center' },
  description: { alignSelf: 'stretch', color: colors.textMuted, fontSize: 16, lineHeight: 24, textAlign: 'center', maxWidth: 520, marginTop: 11 },
  ...
  statLabel: { color: '#4F6F5E', fontSize: 9, fontWeight: '800', letterSpacing: 1.1, marginTop: 2 },
  ...
  primaryButton: { alignSelf: 'stretch', maxWidth: 420, height: 58, paddingHorizontal: 21, borderRadius: 18, backgroundColor: colors.brand, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 25 },
  primaryButtonText: { color: colors.surface, fontSize: 16, fontWeight: '700' },
  arrow: { color: colors.surface, fontSize: 23, marginTop: -2 },
  openApp: { color: colors.brand, fontSize: 14, fontWeight: '700', marginTop: 19 },
  inviteOnly: { alignSelf: 'stretch', color: '#6E6A62', fontSize: 12, textAlign: 'center', marginTop: 18 },
  loading: { minHeight: 530, alignItems: 'center', justifyContent: 'center', gap: 13 },
  loadingText: { color: '#6E6A62', fontSize: 14 },
  ...
  secondaryButtonText: { color: colors.brand, fontSize: 15, fontWeight: '700' },
