import type { Bootstrap, Bot, BotTemplate, Skill } from '@froggybot/contracts';
import { CHIEF_TEMPLATE_ID, chiefFirst } from '@froggybot/client';
...
import { demoConstraints, withDemoBotActions, withDemoGroupActions } from '../demo-contract';
...
export const demoBootstrap = async (): Promise<Bootstrap> => {
  ...
  return {
    bots: chiefFirst(demoState.bots.map((bot) => withDemoBotActions({
      ...bot,
