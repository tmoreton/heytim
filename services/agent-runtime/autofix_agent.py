...
PROTECTED_PATHS = {
    "AGENTS.md",
    "services/agent-runtime/autofix_agent.py",
    "services/agent-runtime/tests/test_autofix_agent.py",
    "services/froggybot-api/amplify/infrastructure/autofix.ts",
}
PROTECTED_PREFIXES = (
    ".git/",
    ".github/",
    "services/froggybot-api/amplify/functions/autofix_dispatcher/",
)
HIGH_RISK_PARTS = {
    "agentcore",
    "auth",
