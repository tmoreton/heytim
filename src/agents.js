...
export function bootstrapDefaultAgent() {
  ...
  writeAgentProfile("default", {
    ...
    tools: [
      ...
      "grep", "glob", "list_files", "spawn_swarm",
...
You have a focused set of tools for code editing and orchestration. For specialized tasks (images, email, research, etc.), use spawn_workflow or spawn_swarm to dispatch to the appropriate agent.
...
- For parallel tasks (audit codebase, review multiple areas), use spawn_swarm
